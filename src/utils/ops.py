...
#         # down_outs=self.GCNList_1(adj_ms,down_outs)
#         down_outs_fuse=self.fuselayer_1(adj_ms,down_outs,indices_list)
#         down_outs_fuse = self.fuselayer_2(adj_ms, down_outs_fuse, indices_list)
#         # down_outs = self.fuselayer_3(adj_ms, down_outs, indices_list)
#         # down_outs = self.fuselayer_4(adj_ms, down_outs, indices_list)
#
#         # down_outs = self.GCNList_2(adj_ms, down_outs, indices_list)
...
class GraphUnet(nn.Module):
    ...
    def forward(self, g, h):
        ...
        # down_outs=self.GCNList_1(adj_ms,down_outs)
        down_outs_fuse=self.fuselayer_1(adj_ms,down_outs,indices_list)
        down_outs_fuse_process=self.GCNList_1(adj_ms,down_outs_fuse)
        down_outs_fuse_2 = self.fuselayer_2(adj_ms, down_outs_fuse_process, indices_list)
        # down_outs = self.fuselayer_3(adj_ms, down_outs, indices_list)
        # down_outs = self.fuselayer_4(adj_ms, down_outs, indices_list)
        ...
        down_outs_fuse_final=[]
        down_outs_fuse_final.append(down_outs_fuse[0]+down_outs_fuse_2[0]+org_h)
        down_outs_fuse_final.append(down_outs_fuse[1] + down_outs_fuse_2[1])
        down_outs_fuse_final.append(down_outs_fuse[2] + down_outs_fuse_2[2])
        down_outs_fuse_final.append(down_outs_fuse[3] + down_outs_fuse_2[3])

        return down_outs_fuse_final
